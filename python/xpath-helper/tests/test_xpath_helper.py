...
#    li_path = XPathHelper().get_element_by_tag("a", filter.attributeContains("href", "wiki/HTTPS")).get_ancestor(filter.value_contains("It's over a,"))
#    elements = html_doc.xpath(str(li_path))
#       assert len(elements) != 0
#       assert "secure connection") == None
...
#    li_path = XPathHelper().get_element_by_tag("a", filter.attributeContains("href", "wiki/HTTPS")).get_ancestor_or_self(filter.value_contains("It's over a,")).get_ancestor_or_self(filter.value_contains("It's over a,"))
#    elements = html_doc.xpath(str(li_path))
#       assert len(elements) != 0
#       assert "secure connection") == None
...
#    li_path = XPathHelper().get_element_by_tag("a", filter.attributeContains("href", "sencrypt")).get_following(filter.attributeGreaterThan("data-number", 21))
#    elements = html_doc.xpath(str(li_path))
#       assert len(elements) != 0
